  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-4">
        ...
        <button 
          onClick={typeof onClose === 'function' ? onClose : onClose?.close}
      ...
      {/* Category Rules Tab */}
      {activeTab === 'categoryRules' && <CategoryRulesTab onEmailsRefresh={typeof onClose === 'object' && onClose.onEmailsRefresh ? onClose.onEmailsRefresh : undefined} />}      {/* Categories Management */}
      {activeTab === 'categories' && (
        <div className="space-y-4">
